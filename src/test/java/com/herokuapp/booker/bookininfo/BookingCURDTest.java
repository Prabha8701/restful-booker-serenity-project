...
public class BookingCURDTest extends TestBase {
    ...
    static String lastName = "Prime" + TestUtils.getRandomValue();
    static int totalPrice = 500;
    static boolean depositPaid = true;
    static String checkIn = "2023-05-07";
    static String checkOut = "2023-05-10";
    static String additionalNeeds = "Breakfast";
    static String username = "Prime_Testing";
    static String password = "prime1234";
